...
- Command approval cards expose Allow once, Auto approve, Deny, and Stop. Auto approve returns Codex's session-wide command decision; network, filesystem, and file-change cards remain one-time only.

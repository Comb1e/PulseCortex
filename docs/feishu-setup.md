...
4. Exercise Allow once, Deny, and Stop on approval cards. Let one harmless request expire and verify PulseCortex denies it automatically and rejects the stale card.

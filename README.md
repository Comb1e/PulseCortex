...
| `/instructions` | Run supported Codex built-in commands or choose an instruction preset using Feishu cards; creates a session when none is selected |

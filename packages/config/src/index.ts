...
export interface RuntimeConfig extends PublicConfig { dataDir: string; databasePath: string; settingsPath: string; logDir: string; commandLogDir: string; secrets: Secrets }
